...
export function BundlesCta() {
  return (
    <section className="border-t border-black/6 bg-[#fafafa] py-14 sm:py-16">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 sm:flex-row sm:px-6 lg:px-8">
        <div className="text-center sm:text-left">
          <p className="text-lg font-medium text-home-charcoal">Need individual compounds?</p>
          <p className="mt-1 text-sm text-home-charcoal/65">
            Browse the full catalogue of HPLC/MS-verified research peptides.
          </p>
        </div>
        <Link
          href="/shop"
